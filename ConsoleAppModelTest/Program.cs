...
namespace ConsoleAppModelTest
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string connectionString= @"Data Source=DESKTOP-TENLUD8\SQLEXPRESS;Initial Catalog=ParkbeheerS;Integrated Security=True";
            ...
            Huurder h = new Huurder(1, "Jos", new Contactgegevens("email1", "tel", "adres"));
            Park p1 = new Park("p1", "Buitenhoeve", "Deinze");
            Huis huis = new Huis(1, "Kerkstraat", 5, true, p1);
